...
<head>
    ...
    <script src="//ajax.macg.moe/ajax/libs/jquery/2.1.4/jquery.min.js" ></script>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="moefq.php">
                        <i class="fa fa-rocket"></i> <span>MoeFQ 后台设置</span>
                    </a>
                </li>
                <li>
                    <a href="paycode.php">
                        <i class="fa fa-credit-card"></i><span>付款码</span>
                    </a>
                </li>
