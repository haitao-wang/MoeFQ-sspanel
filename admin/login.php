...
<body class="login-page" style="background-image:url(3.jpg);background-size:cover;background-position:center;">
<div class="login-box">
    <div class="login-logo">
        <a href="#"  style="color:#fff;"><b><?php echo $site_name;  ?></b></a>
    </div><!-- /.login-logo -->
