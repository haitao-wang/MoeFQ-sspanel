...
<div class="register-box">
    <div class="register-logo">
        <a href="../"><b><?php echo $site_name;?> - 注册</b></a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">注册，来到真正的"Internet"。</p>
            ...
            <div class="form-group has-feedback">
                <input type="text" id="question" class="form-control" placeholder="请输入一个你喜欢的密保问题"/>
                <span class="glyphicon glyphicon-pencil form-control-feedback"></span>
            </div>  
            <div class="form-group has-feedback">
                <input type="text" id="answer" class="form-control" placeholder="输入密保问题的答案"/>
            ...
            <div class="form-group has-feedback">
               <p>注册即代表同意<a href="tos.php">MoeFQの服务条款</a></p>
            </div>
        ...
        <a href="login.php" class="text-center">已有账号的MoeFQ用户请戳这里w</a>
    </div><!-- /.form-box -->
         ...
         function register(){
            $.ajax({
                ...
                data:{
                    ...
                    code: $("#code").val(),
                    agree: $("#agree").val()
                    <?php if(isset($_GET['inviter'])) echo ',inviter: '.$_GET['inviter']; ?>
                },
