            ...
            <div class="col-md-6">
                <div class="box box-success">
                    <div class="box-header">
                        ...
                        <div class="box-body">
                        <p>将下面的链接连同邀请码复制给好友，如果好友成功地从这个链接注册，那么您和好友可以同时获赠1GB的额外额度。</p>
                        <div class="input-group">
                        <span class="input-group-addon">我的推广链接</span>
                        <input type="text" class="form-control" value="<?php echo $U->userSpreadLink(); ?>"/>
                        </div>
                        <br/>
                        <p>注意：也请邀请你认识的人。如果发现您有作弊の操作（恶意注册等），那么您和被您邀请的用户将会被做封禁和删除处理。</p>
                        <p>截止目前为止您已经邀请了<code><?php echo $U->userInviteNum(); ?></code> 名好友。</p>
                        </div>
                    </div>
                </div>
