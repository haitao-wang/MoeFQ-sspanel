...
<head>
  ...
  <!-- <link href="http://cdn.bootcss.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" /> -->
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="../user/style-kotori.css"/>
</head>
<body class="login-page">
<div class="login-box">
    <div class="login-logo">
        <a href="#" style="font-family:'roboto',Microsoft Yahei;"><b><?php echo $site_name;  ?></b></a>
    </div><!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">回到位于二次元的 <?php echo $site_name; ?> 用户中心</p>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input id="remember_me" value="week" type="checkbox"> 记住我喵！
                        </label>
                    </div>
                </div><!-- /.col -->
                <div class="col-xs-4">
            ...
            <div id="msg-success" class="alert alert-info alert-dismissable" style="display: none;">
                ...
                <h4><i class="icon fa fa-info"></i> 欢迎回来(´ε｀)</h4>
                <p id="msg-success-p"></p>
            </div>
            <div id="msg-error" class="alert alert-warning alert-dismissable" style="display: none;">
                <button type="button" class="close" id="error-close" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-warning"></i> 啊嘞_(:з」∠)_</h4>
                <p id="msg-error-p"></p>
            </div>
            <br/>
        <a href="resetpwd.php">窝忘惹密码ﾍ(;´Д｀ﾍ)</a>
        <a href="register.php" class="text-center" style="float:right;">是新人哦(๑>؂<๑）</a>
